...
class LAProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        */
        ...
        // Artisan::call('migrate', ['--path' => "vendor/Karim88/laraadmin/src/Migrations/"]);
        //echo "Migrations completed !!!.";
        // Execute by php artisan vendor:publish --provider="Karim88\Laraadmin\LAProvider"
    ...
    public function register()
    {
        ...
        */
        ...
        $loader->alias('CodeGenerator', \Karim88\Laraadmin\CodeGenerator::class);
        
        // For LaraAdmin Form Helper
        $loader->alias('LAFormMaker', \Karim88\Laraadmin\LAFormMaker::class);
        
        // For LaraAdmin Helper
        $loader->alias('LAHelper', \Karim88\Laraadmin\Helpers\LAHelper::class);
        
        // LaraAdmin Module Model 
        $loader->alias('Module', \Karim88\Laraadmin\Models\Module::class);
        
        // For LaraAdmin Configuration Model
        $loader->alias('LAConfigs', \Karim88\Laraadmin\Models\LAConfigs::class);
        ...
        */
        ...
        $this->app->make('Karim88\Laraadmin\Controllers\ModuleController');
        $this->app->make('Karim88\Laraadmin\Controllers\FieldController');
        $this->app->make('Karim88\Laraadmin\Controllers\MenuController');
        
        // For LAEditor
        if(file_exists(__DIR__ . '/../../laeditor')) {
            $this->app->make('Karim88\Laeditor\Controllers\CodeEditorController');
        }
        ...
        */
        ...
        $commands = [
            \Karim88\Laraadmin\Commands\Migration::class,
            \Karim88\Laraadmin\Commands\Crud::class,
            \Karim88\Laraadmin\Commands\Packaging::class,
            \Karim88\Laraadmin\Commands\LAInstall::class
        ];
        
        // For LAEditor
        if(file_exists(__DIR__ . '/../../laeditor')) {
            $commands[] = \Karim88\Laeditor\Commands\LAEditor::class;
        }
